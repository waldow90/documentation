...
For elements like radio buttons, input borders and more the, instead of the primary ``color`` value, ``color-element-bright` should be used on bright background, and ``color-element-dark`` on dark background.
